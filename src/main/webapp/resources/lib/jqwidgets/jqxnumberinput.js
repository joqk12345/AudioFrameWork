...
(function (a) {
    ...
    a.extend(a.jqx._jqxNumberInput.prototype, {defineInstance: function () {
        ...
        this.aria = {"aria-valuenow": {name: "decimal", type: "number"}, "aria-valuemin": {name: "min", type: "number"}, "aria-valuemax": {name: "max", type: "number"}, "aria-disabled": {name: "disabled", type: "boolean"}};
