...
(function (i) {
    ...
    i.jqx.dataAdapter.prototype = {getrecords: function () {
                ...
                if (U._localdata) {
                        ...
                        if (typeof al === "string") {
                            ...
                            i.each(this, function (au, az) {
                                ...
                                if (aa > 0) {
                                    ...
                                    for (var at = 0; at < aa; at++) {
                                        ...
                                        if (ar != undefined && (ar.name == au)) {
                                            ...
                                            if (ar != undefined && ar.map && (ar.map.indexOf(au) >= 0)) {
                                                aC = true;
                                                ao = ar.map;
                                                aA = ar.type;
                                                ay = ar.name;
                                                ...
                                                if (aA != "string") {
                                                    aB = ae.getvaluebytype(aB, {type: aA})
                                                }
                                                ag[ay] = aB;
                                                if (ag[ay] != undefined) {
                                                    ak += ag[ay].toString().length + ag[ay].toString().substr(0, 1)
                                                }
                                            }
                                        }
                                    }
                                ...
                                if (aq) {
                                    ...
                                    if (aj[au].subscribe) {
                                        var aw = ai;
                                        ae.koSubscriptions[ae.koSubscriptions.length] = aj[au].subscribe(function (aE) {
                                            var aD = aw;
                                            ag[au] = aE;
                                            var aF = {index: aD, oldrecord: ag, record: ag};
                                            ae._changedrecords.push(aF);
                                            if (ae.isUpdating) {
                                                return
                                            }
                            ...
                            if (ae._oldrecords) {
                                ...
                                if (X == "update") {
                                    if (ae._oldrecords[af]._koindex != ak) {
                                        var am = {index: af, oldrecord: ae._oldrecords[af], record: ag};
                    ...
                    if (X == "add") {
                        ...
                        for (var W = 0; W < M; W++) {
                            ...
                            if (!L) {
                                ae._changedrecords.push({index: W, oldrecord: null, record: I, position: (W != 0 ? "last" : "first")})
                            }
                        }
                    } else {
                        if (X == "remove") {
                            ...
                            for (var W = 0; W < M; W++) {
                                ...
                                if (!ae.records[W]) {
                                    ae._changedrecords.push({index: W, oldrecord: P, record: null})
                                } else {
            ...
            case"text":
                ...
                if (U.url && U.url.length > 0) {
                    if (i.isFunction(K.loadServerData)) {
                        ...
                        this.xhr = i.jqx.data.ajax({dataType: Q, cache: this.cache, type: J, url: U.url, async: N, contentType: Y, data: ac, success: function (ai, af, al) {
                            if (i.isFunction(U.beforeprocessing)) {
                    ...
                    var J = function (L) {
                        if (L) {
                            for (var M = 0; M < L.length; M++) {
                                var N = L[M];
                                if (N.uid == K) {
                                    var O = (I._source && I._source.hierarchy) ? I._source.hierarchy.reservedNames : null;
                                    H[O.parent] = N;
                                    H[O.level] = N[O.level] + 1;
                                    if (!N.records) {
                                        N.records = new Array()
                                    }
                                    if (e == "last") {
                                        ...
                                        if (typeof e === "number" && isFinite(e)) {
                                            N.records.splice(e, 0, H)
                                        } else {
                                            N.records.splice(0, 0, H)
                                        }
                                    }
                                    I.records.push(H);
                                    return true
        ...
        return N
    }, getAggregatedData: function (R, N, L) {
        var K = L;
        if (!K) {
            K = this.records
        }
                ...
                if (H.aggregates) {
                    ...
                    var e = function (V) {
                        for (obj in V) {
                            ...
                            if (i.isFunction(V[obj])) {
                                W = V[obj](W, T, H.name, Q)
                            }
                            O[H.name][obj] = W
                        }
                    };
                        ...
                        i.each(H.aggregates, function () {
                            ...
                            if (this == "sum" || this == "avg" || this == "stdev" || this == "stdevp" || this == "var" || this == "varp") {
                                ...
                                if (this == "product") {
                                    ...
                                    if (this == "min") {
                                        V = Math.min(V, parseFloat(T))
                                    } else {
                                        if (this == "max") {
                                            V = Math.max(V, parseFloat(T))
                                        } else {
                                            if (this == "count") {
                                                V++
                                            } else {
        ...
        for (var M = 0; M < R.length; M++) {
            ...
            if (!O[H.name]) {
                O[H.name] = {};
                i.each(H.aggregates, function (V) {
                    O[H.name][this] = 0
                })
            }
            if (O[H.name]["avg"] != undefined) {
                var T = O[H.name]["avg"];
                var U = J[H.name];
                if (U === 0 || U == undefined) {
                    O[H.name]["avg"] = 0
                ...
                if (O[H.name]["count"] != undefined) {
                    O[H.name]["count"] = I
                }
            }
            if (O[H.name]["stdev"] || O[H.name]["stdevp"] || O[H.name]["var"] || O[H.name]["varp"]) {
                i.each(H.aggregates, function (ab) {
                    if (this == "stdev" || this == "var" || this == "varp" || this == "stdevp") {
                        var ac = O[H.name][this];
                        var aa = I;
                        var V = (ac / I);
                        var X = 0;
                        for (var Y = 0; Y < I; Y++) {
                        ...
                        var W = (this == "stdevp" || this == "varp") ? aa : aa - 1;
                        if (W == 0) {
                            W = 1
                        }
            ...
            if (H.formatStrings) {
                i.each(H.aggregates, function (W) {
                    var V = H.formatStrings[W];
                    if (V) {
                        if (this == "min" || this == "max" || this == "count" || this == "product" || this == "sum" || this == "avg" || this == "stdev" || this == "stdevp" || this == "var" || this == "varp") {
                            var X = O[H.name][this];
                            O[H.name][this] = i.jqx.dataFormat.formatnumber(X, V, N)
                        } else {
                            if (typeof this == "object") {
                                for (obj in this) {
                                    var X = O[H.name][obj];
                                    O[H.name][obj] = i.jqx.dataFormat.formatnumber(X, V, N)
                                }
                            }
                        }
                    }
    ...
    i.extend(i.jqx.data, {ajaxSetup: function (H, e) {
        ...
        J = J || {};
        var P, ad, K, Y, R, V, I, X, Q = i.jqx.data.ajaxSetup({}, J), af = Q.context || Q, T = af !== Q && (af.nodeType || af instanceof jQuery) ? jQuery(af) : jQuery.event, ae = jQuery.Deferred(), aa = jQuery.Callbacks("once memory"), N = Q.statusCode || {}, U = {}, ab = {}, L = 0, O = "canceled", W = {readyState: 0, setRequestHeader: function (ag, ah) {
            if (!L) {
    ...
    i.jqx.filter = function () {
        ...
        var T = function (V, U) {
            ...
            this.evaluate = function (af) {
                ...
                var Z = new Array();
                if (ae && ae.indexOf) {
                    if (ae.indexOf(" ") >= 0 || ae.indexOf("|") >= 0 || ae.indexOf(" AND ") >= 0 || ae.indexOf(" OR ") >= 0 || ae.indexOf(" and ") >= 0 || ae.indexOf(" or ") >= 0) {
                        var aa = am(an, ae);
                        if (aa) {
                            return aa
                        }
