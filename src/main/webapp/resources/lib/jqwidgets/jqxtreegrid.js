...
(function (a) {
    ...
    a.extend(a.jqx._jqxTreeGrid.prototype, {defineInstance: function () {
        ...
        var aF = M.toTP("jqx-cell") + " " + M.toTP("jqx-widget-content");
        if (M.rtl) {
        ...
        if (C === 0) {
            ...
            var aF = M.toTP("jqx-cell") + " " + M.toTP("jqx-grid-cell");
        ...
        for (var P = 0; P < v.length; P++) {
            ...
            var T = 0;
            if (!M.rowinfo[ab]) {
                M.rowinfo[ab] = {selected: ap[I.selected], checked: ap[I.checked], icon: ap[I.icon], aggregate: ap.aggregate, row: ap, leaf: ap[I.leaf], expanded: ap[I.expanded]}
            } else {
            ...
            for (var O = 0; O < b; O++) {
                ...
                var ah = '<td role="gridcell"' + Q + ' style="visibility: hidden; border-color: transparent; max-width:' + at + "px; width:" + at + "px;";
                if (O == b - 1 && b == 1) {
            ...
            if (M.rowdetails && !ap.aggregate && this.rowDetailsRenderer) {
                var l = '<tr data-role="row-details"><td valign="top" align="left" style="max-width:' + at + "px; width:" + at + 'px; overflow: hidden; border-left: none; border-right: none;" colspan="' + M.columns.records.length + '" role="gridcell"';
                var aF = M.toTP("jqx-cell") + " " + M.toTP("jqx-grid-cell");
                aF += " " + M.toTP("jqx-details");
                aF += " " + M.toTP("jqx-reset");
                var af = this.rowDetailsRenderer(ab, ap);
                if (af) {
                    l += '" class="' + aF + '"><div style="overflow: hidden;"><div data-role="details">' + af + "</div></div></td></tr>";
                    y += l;
                    V += l
                }
            }
