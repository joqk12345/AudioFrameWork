...
(function (a) {
    ...
    a.extend(a.jqx._jqxMenu.prototype, {defineInstance: function () {
        ...
        p.css({visibility: "visible", display: "block", left: b, top: k ? j.top + h.outerHeight() : j.top, zIndex: m});
        u.css("display", "block");
        ...
        switch (s.openVerticalDirection) {
            ...
            case"center":
                if (k) {
                    ...
                    u.css("top", 0);
                    p.css({display: "block", top: j.top + h.outerHeight() / 2 - p.outerHeight() / 2 + f[1], zIndex: m})
                }
                break
        }
        ...
        a.each(this.items, function () {
            ...
            if (q.subMenuElement != null) {
                ...
                n.css({overflow: "hidden", position: "absolute", left: 0, display: "inherit", top: -n.outerHeight()});
                n.data("timer", {});
                if (q.level > 0) {
                ...
                h++;
                var p = a(q.subMenuElement).closest("div.jqx-menu-popup").css({width: parseInt(a(q.subMenuElement).outerWidth()) + parseInt(c[0]) + "px", height: parseInt(a(q.subMenuElement).outerHeight()) + parseInt(c[1]) + "px"});
                    ...
                    if (!e) {
                        ...
                        f.addHandler(m, "mouseleave", function (t) {
                            if (f.autoCloseOnMouseLeave) {
                                ...
                                var v = {left: parseInt(w.coord().left), top: parseInt(w.coord().top), width: parseInt(w.outerWidth()), height: parseInt(w.outerHeight())};
                                var u = true;
