...
(function (a) {
    a.extend(a.jqx._jqxGrid.prototype, {_handledblclick: function (t, n) {
            ...
            if (F == 32) {
                if (v.editcell.columntype == "checkbox") {
                    ...
                    if (e.editable) {
                        ...
                        v._raiseEvent(18, {rowindex: v.editcell.row, datafield: v.editcell.column, oldvalue: !l, value: l, columntype: "checkbox"});
                        return false
                    }
                }
            }
            ...
            if (F == 32) {
                ...
                if (c != null) {
                    ...
                    if (e.columntype == "checkbox" && e.editable) {
                        ...
                        v._raiseEvent(17, {rowindex: c.rowindex, datafield: c.datafield, value: !l, columntype: "checkbox"});
                        v.setcellvalue(c.rowindex, c.datafield, l, true);
                        v._raiseEvent(18, {rowindex: c.rowindex, datafield: c.datafield, oldvalue: !l, value: l, columntype: "checkbox"});
                        return false
                    }
                }
            }
            ...
            if (this.editcell) {
                ...
                if (!this.editcell.editing) {
                    ...
                    if (f.columntype != "checkbox" && this.editmode != "selectedrow") {
                        this._raiseEvent(17, {rowindex: m, datafield: f.datafield, value: this.editcell.value, columntype: f.columntype})
                    }
        ...
        var f = function (v) {
            ...
            v._raiseEvent(18, {rowindex: g, datafield: m, displayfield: d.displayfield, oldvalue: h, value: h, columntype: d.columntype});
        ...
        if (d.cellendedit) {
            ...
            if (r == false) {
                this._raiseEvent(18, {rowindex: g, datafield: m, displayfield: d.displayfield, oldvalue: oldvalue, value: oldvalue, columntype: d.columntype});
                f(this);
                return false
            }
        }
        this._raiseEvent(18, {rowindex: g, datafield: m, displayfield: d.displayfield, oldvalue: oldvalue, value: h, columntype: d.columntype});
        ...
        a.each(this.columns.records, function (f, g) {
            if (b.editable && this.editable) {
                ...
                b._raiseEvent(17, {rowindex: c, datafield: this.datafield, value: e.value, columntype: this.columntype})
            }
        });
        if (b.editcell) {
        ...
        for (var x = 0; x < this.columns.records.length; x++) {
            ...
            var g = function (B) {
                ...
                B._raiseEvent(18, {rowindex: k, datafield: r, displayfield: e.displayfield, oldvalue: A, value: A, columntype: e.columntype});
        ...
        if (!h) {
            ...
            for (var x = 0; x < this.columns.records.length; x++) {
                ...
                if (e.columntype == "checkbox") {
                    ...
                    this._raiseEvent(18, {rowindex: k, datafield: e.datafield, displayfield: e.displayfield, oldvalue: l, value: l, columntype: e.columntype});
                    continue
                }
                if (!d[e.datafield]) {
                    continue
                ...
                if (e.cellendedit) {
                    ...
                    if (w == false) {
                        this._raiseEvent(18, {rowindex: k, datafield: r, displayfield: e.displayfield, oldvalue: m, value: m, columntype: e.columntype});
                        g(this);
                        continue
                    }
                }
                this._raiseEvent(18, {rowindex: k, datafield: e.datafield, displayfield: e.displayfield, oldvalue: m, value: l, columntype: e.columntype});
                u[e.datafield] = l
            }
            var j = this.getrowid(k);
            var f = this.getrowdata(k);
            a.each(u, function (i, A) {
                f[i] = A
            });
            if (!this.enablebrowserselection) {
                this.host.addClass("jqx-disableselect");
        ...
        var b = this;
        a.each(this.columns.records, function (f, h) {
            ...
            switch (this.columntype) {
                case"dropdownlist":
                    ...
                    break;
                case"combobox":
                    var j = b.editors["combobox_" + c];
                    if (j) {
                        j.jqxComboBox("destroy");
                ...
                case"template":
                    ...
                    if (this.destrotemplateeditor) {
                        var l = b.getrows.length();
                        for (var k = 0; k < l; k++) {
                            this.destrotemplateeditor(b.editors["templateeditor_" + c + "_" + k]);
                            b.editors["templateeditor_" + c + "_" + k] = null
                        }
                    }
                    break
            }
                ...
                if (this.host.jqxDropDownList) {
                    ...
                    if (k == undefined) {
                        ...
                        if (!f) {
                            ...
                            x = new a.jqx.dataAdapter(o, {autoBind: false, async: false, uniqueDataFields: [A], autoSort: true, autoSortField: A})
                        }
            ...
            case"numberinput":
                if (this.host.jqxNumberInput) {
                    ...
                    if (M == undefined) {
                        ...
                        d.jqxNumberInput({decimalSeparator: this.gridlocalization.decimalseparator, decimalDigits: L, inputMode: "simple", theme: this.theme, rtl: this.rtl, width: g.width() - 1, height: g.height() - 1, spinButtons: true, symbol: m, symbolPosition: y});
