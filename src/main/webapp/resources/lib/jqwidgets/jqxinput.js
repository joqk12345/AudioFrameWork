...
(function (a) {
    ...
    a.extend(a.jqx._jqxInput.prototype, {defineInstance: function () {
        ...
        if ("placeholder" in this.element) {
            ...
            if (this.host.val() == "") {
                ...
                this.host.focus(function () {
                    if (b.host.val() == b.placeHolder) {
                        b.host.val("")
                    }
                });
                this.host.blur(function () {
                    if (b.host.val() == "" || b.host.val() == b.placeHolder) {
                        b.host.val(b.placeHolder)
                    }
                })
            }
        }
        ...
        this.host.val(this.renderer(b, this.host.val()));
        ...
        this.addHandler(this.host, "focus", a.proxy(this.focus, this));
        this.addHandler(this.host, "blur", a.proxy(this.blur, this));
        ...
        this.removeHandler(this.host, "blur", a.proxy(this.blur, this));
