...
(function (a) {
    ...
    a.extend(a.jqx._jqxTabs.prototype, {defineInstance: function () {
            ...
            if (d == 1) {
                ...
                if (this.selectionTracker || this.animationType != "none") {
                    ...
                    if (this._contentList.length > 0 && this._contentList[this.selectedItem]) {
                        this._contentList[this.selectedItem].find("div").trigger(f)
                    }
                }
            }
        } catch (c) {
        ...
        if (d >= 0 || d <= this.length()) {
            ...
            e.addClass(this.toThemeProperty("jqx-tabs-content-element"));
            if (this.position == "bottom") {
            ...
            e.appendTo(this._contentWrapper);
            this._addItemTo(this._titleList, d, b);
            this._addItemTo(this._contentList, d, e);
