...
(function (a) {
    ...
    a.extend(a.jqx._jqxDragDrop.prototype, {defineInstance: function () {
            ...
            if (window.top != null) {
                ...
                if (d.indexOf(document.location.host) != -1) {
                    ...
                    if (window.top.document.addEventListener) {
                        window.top.document.addEventListener("mouseup", c, false)
                    } else {
                        if (window.top.document.attachEvent) {
                            window.top.document.attachEvent("onmouseup", c)
                        }
                    }
                }
            }
        ...
        if (this.dropTarget) {
            var b = this.feedback.offset(), c = this.feedback.outerWidth(), d = this.feedback.outerWidth(), e = this._over(b, c, d);
            if (e.over) {
                    ...
                    if (l && !n.disabled) {
                        ...
                        if (p != null && !p.isGroup) {
                            ...
                            if (n.dropAction != "none") {
                                ...
                                if (b.dragEnd) {
                                    var r = b.dragEnd(b._dragItem, b._dragItem, f.args);
                                    if (r == false) {
                                        a(f.args.element).jqxDragDrop({triggerEvents: false});
                                        a(f.args.element).jqxDragDrop("cancelDrag");
                                        clearInterval(b._autoScrollTimer);
