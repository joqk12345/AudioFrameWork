...
(function (a) {
    ...
    a.extend(a.jqx._jqxRadioButton.prototype, {defineInstance: function () {
        this.animationShowDelay = 300, this.animationHideDelay = 300, this.width = null;
        this.height = null;
        this.boxSize = "13px";
        this.checked = false;
        ...
        var d = a.find(".jqx-radiobutton");
        if (this.groupName == null) {
            this.groupName = ""
        }
        a.each(d, function () {
            var e = a(this).jqxRadioButton("groupName");
            if (e == c.groupName && this != c.element) {
                a(this).jqxRadioButton("uncheck")
            }
        });
        this._raiseEvent("0");
