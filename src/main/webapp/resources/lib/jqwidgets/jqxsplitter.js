...
(function (a) {
    ...
    a.extend(a.jqx._jqxSplitter.prototype, {defineInstance: function () {
        ...
        var f = function () {
            ...
            if (j.splitBar[0].style[t] != w + "px") {
                ...
                if (j.orientation == "vertical") {
                    ...
                    j.splitBarButton.width(j._splitBarSize);
                    j.splitBarButton.css("left", "0px")
                } else {
                    j.splitBar[0].style.borderTopColor = "";
                    j.splitBar[0].style.borderBottomColor = "";
                    j.splitBarButton.height(j._splitBarSize);
                    j.splitBarButton.css("top", "0px")
                }
                if (j._hasBorder) {
                    if (i - m == w) {
                        if (j.orientation == "vertical") {
                            j.splitBar[0].style.borderRightColor = "transparent";
                            j.splitBarButton.width(j._splitBarSize + 1)
                        } else {
                            j.splitBar[0].style.borderBottomColor = "transparent";
                            j.splitBarButton.height(j._splitBarSize + 1)
                        }
                    } else {
                        if (w == 0) {
                            if (j.orientation == "vertical") {
                                ...
                                j.splitBarButton.width(j._splitBarSize + 1);
                                j.splitBarButton.css("left", "-1px")
                            } else {
                                j.splitBar[0].style.borderTopColor = "transparent";
                                j.splitBarButton.height(j._splitBarSize + 1);
                                j.splitBarButton.css("top", "-1px")
                            }
                        }
                    }
                }
                j.splitBar.css(t, x + "px")
            }
            if (j.panel2[0].style[t] != w + m + "px") {
                j.panel2.css(t, w + m + "px")
            }
        };
        if (e) {
        ...
        b[0] = {};
        b[1] = {};
        b[0].size = this.panel1[c]();
        b[1].size = this.panel2[c]();
