                            ...
                            if (osName == "RIMTablet") {
                                ...
                                if (osName == "Android") {
                                    if (this.os.version.indexOf("3") >= 0) {
                                        ...
                                        if (this.os.version.indexOf("4") >= 0 && navigator.userAgent.search(/mobile/i) == -1) {
                                            deviceType = "Tablet"
                                        } else {
                                            deviceType = "Phone"
                                        }
