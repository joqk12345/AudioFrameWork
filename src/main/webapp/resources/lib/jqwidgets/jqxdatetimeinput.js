...
(function (a) {
    ...
    a.extend(a.jqx._jqxDateTimeInput.prototype, {defineInstance: function () {
        ...
        this.aria = {"aria-valuenow": {name: "getDate", type: "date"}, "aria-valuetext": {name: "getText", type: "string"}, "aria-valuemin": {name: "min", type: "date"}, "aria-valuemax": {name: "max", type: "date"}, "aria-disabled": {name: "disabled", type: "boolean"}}
        ...
        var d = function () {
            if (c.calendarContainer) {
                ...
                if (c.dropDownWidth == "auto") {
                    var f = c.host.width();
                    c.calendarContainer.jqxCalendar({width: f});
