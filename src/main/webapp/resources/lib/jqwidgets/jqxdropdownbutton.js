...
(function (a) {
    ...
    a.extend(a.jqx._jqxDropDownButton.prototype, {defineInstance: function () {
        ...
        if (this.popupContent.length == 0) {
            this.popupContent = a("<div>" + this.host.text() + "</div>");
        ...
        try {
            var f = "dropDownButtonPopup" + this.element.id;
            var d = a(a.find("#" + f));
            if (d.length > 0) {
                d.remove()
            }
            ...
            var b = a("<div class='dropDownButton' style='overflow: hidden; left: 0px; top: 0px; position: absolute;' id='dropDownButtonPopup" + this.element.id + "'></div>");
            b.addClass(this.toThemeProperty("jqx-widget-content"));
            b.addClass(this.toThemeProperty("jqx-dropdownbutton-popup"));
            b.addClass(this.toThemeProperty("jqx-popup"));
            b.addClass(this.toThemeProperty("jqx-rc-all"));
            b.css("z-index", this.popupZIndex);
            if (a.jqx.browser.msie) {
                b.addClass(this.toThemeProperty("jqx-noshadow"))
            }
            this.popupContent.appendTo(b);
        ...
        this.dropDownButtonStructure = c;
        this.host.append(c);
        ...
        this.arrow = a(this.dropDownButtonArrow.children()[0]);
        ...
        if (this.host.parents()) {
            this.addHandler(this.host.parents(), "scroll.dropdownbutton" + this.element.id, function (e) {
                var l = k.isOpened();
                if (l) {
                    k.close()
                }
        ...
        this.addHandler(this.dropDownButtonWrapper, "selectstart", function () {
            return false
        });
        ...
        var k = this;
        this.propertyChangeMap.disabled = function (e, m, l, n) {
            if (n) {
                e.host.addClass(k.toThemeProperty("jqx-dropdownlist-state-disabled"));
                e.host.addClass(k.toThemeProperty("jqx-fill-state-disabled"));
                e.dropDownButtonContent.addClass(k.toThemeProperty("jqx-dropdownlist-content-disabled"))
            } else {
                e.host.removeClass(k.toThemeProperty("jqx-dropdownlist-state-disabled"));
                e.host.removeClass(k.toThemeProperty("jqx-fill-state-disabled"));
                e.dropDownButtonContent.removeClass(k.toThemeProperty("jqx-dropdownlist-content-disabled"))
            }
        ...
        if (a.jqx.browser.msie && a.jqx.browser.version < 8) {
            ...
            if (this.host.parents(".jqx-window").length > 0) {
                ...
                b.css("z-index", j + 10);
                this.container.css("z-index", j + 10)
            }
        }
    }, setContent: function (b) {
        this.dropDownButtonContent.children().remove();
        this.dropDownButtonContent[0].innerHTML = "";
        this.dropDownButtonContent.append(b)
    }, val: function (b) {
        if (arguments.length == 0 || typeof (b) == "object") {
            return this.dropDownButtonContent.text(b)
        } else {
            this.dropDownButtonContent.html(b)
        }
    }, getContent: function () {
        ...
        var c = this;
        var b = a.data(document.body, "openedJQXButton" + this.element.id);
        ...
        if (b.autoOpen) {
            ...
            this.addHandler(a(document), "mousemove." + b.element.id, function (g) {
                var f = b.isOpened();
                if (f && b.autoOpen) {
                    var k = b.host.coord();
                    var j = k.top;
                    ...
                    var e = h.top;
                    canClose = true;
                    if (g.pageY >= j && g.pageY <= j + b.host.height()) {
                        if (g.pageX >= i && g.pageX < i + b.host.width()) {
                            canClose = false
                        }
                    }
                    if (g.pageY >= e && g.pageY <= e + b.container.height()) {
                        if (g.pageX >= d && g.pageX < d + b.container.width()) {
                            canClose = false
                        }
                    }
                    if (canClose) {
        ...
        this.addHandler(this.dropDownButtonWrapper, "mousedown", function (e) {
            if (!b.disabled) {
                var d = b.container.css("visibility") == "visible";
                if (!b.isanimating) {
                    if (d) {
                        b.close();
                        return false
        ...
        if (this.touch) {
            this.addHandler(a(document), a.jqx.mobile.getTouchEventName("touchstart") + "." + this.element.id, b.closeOpenedDropDown, {me: this, popup: this.container, id: this.element.id})
        }
        this.addHandler(a(document), "mousedown." + this.element.id, b.closeOpenedDropDown, {me: this, popup: this.container, id: this.element.id});
        ...
        this.removeHandler(a(document), "mousemove." + b.element.id)
    }, _findPos: function (c) {
        ...
        if ((this.dropDownWidth == null || this.dropDownWidth == "auto") && this.width != null && this.width.indexOf && this.width.indexOf("%") != -1) {
            ...
            this.container.width(parseInt(c))
        }
        p._raiseEvent("2");
        var b = this.popupContent;
        var m = a(window).scrollTop();
        var i = a(window).scrollLeft();
        var l = parseInt(this._findPos(this.host[0])[1]) + parseInt(this.host.outerHeight()) - 1 + "px";
        var f, h = parseInt(Math.round(this.host.coord(true).left));
        f = h + "px";
        ...
        var k = function () {
            if (this.dropDownHorizontalAlignment == "right" || this.rtl) {
                var s = this.container.width();
                var r = Math.abs(s - this.host.width());
                if (s > this.host.width()) {
                    this.container.css("left", parseInt(Math.round(h)) - r + "px")
                } else {
                    this.container.css("left", parseInt(Math.round(h)) + r + "px")
                }
            }
        ...
        if (this.enableBrowserBoundsDetection) {
            var j = this.testOffset(b, {left: parseInt(this.container.css("left")), top: parseInt(l)}, parseInt(this.host.outerHeight()));
            if (parseInt(this.container.css("top")) != j.top) {
                q = true;
                this.container.height(b.outerHeight());
                b.css("top", 23);
                if (this.interval) {
                    clearInterval(this.interval)
                }
                this.interval = setInterval(function () {
                    if (b.outerHeight() != p.container.height()) {
                        var r = p.testOffset(b, {left: parseInt(p.container.css("left")), top: parseInt(l)}, parseInt(p.host.outerHeight()));
                        p.container.css("top", r.top);
                        p.container.height(b.outerHeight())
                    }
                }, 50)
            } else {
                b.css("top", 0)
        ...
        if (this.animationType == "none") {
            ...
            a.data(document.body, "openedJQXButtonParent", p);
            a.data(document.body, "openedJQXButton" + this.element.id, b);
            b.css("margin-top", 0);
            b.css("opacity", 1);
            this._raiseEvent("0");
            k.call(p)
            ...
            if (this.animationType == "fade") {
                b.css("margin-top", 0);
                b.css("opacity", 0);
                b.animate({opacity: 1}, this.openDelay, function () {
                    a.data(document.body, "openedJQXButtonParent", p);
                    a.data(document.body, "openedJQXButton" + p.element.id, b);
                    p.ishiding = false;
                    p.isanimating = false;
                    p._raiseEvent("0")
                });
                ...
                k.call(p);
                b.animate({"margin-top": 0}, this.openDelay, function () {
                    a.data(document.body, "openedJQXButtonParent", p);
                    a.data(document.body, "openedJQXButton" + p.element.id, b);
                    p.ishiding = false;
                    p.isanimating = false;
        ...
        a.data(document.body, "openedJQXButton" + this.element.id, null);
        if (this.animationType == "none") {
            this.container.css("visibility", "hidden");
            if (c) {
                this.container.css("display", "none")
            ...
            if (!f.ishiding) {
                ...
                if (this.animationType == "fade") {
                    e.css({opacity: 1});
                    e.animate({opacity: 0}, this.closeDelay, function () {
                    ...
                    e.animate({"margin-top": g}, this.closeDelay, function () {
                        d.css("visibility", "hidden");
                        f.isanimating = false;
                        f.ishiding = false;
                        if (c) {
        ...
        var c = f - d - 2 * g;
        if (c > 0) {
            this.dropDownButtonContent.width(c + "px")
        }
        this.dropDownButtonContent.height(b);
        this.dropDownButtonContent.css("left", 0);
        this.dropDownButtonContent.css("top", 0);
        this.dropDownButtonArrow.width(d);
        this.dropDownButtonArrow.height(b);
        if (this.rtl) {
            this.dropDownButtonArrow.css("float", "left");
            this.dropDownButtonContent.css("float", "right");
            this.dropDownButtonContent.css("left", -g)
        }
        if (this.dropDownWidth != null) {
            if (this.dropDownWidth.toString().indexOf("%") >= 0) {
                var f = (parseInt(this.dropDownWidth) * this.host.width()) / 100;
                this.container.width(f)
            } else {
        ...
        this.removeHandler(a(document), "mousedown." + this.element.id, self.closeOpenedDropDown);
        this.host.remove();
        ...
        if (f == 2 && !this.contentInitialized) {
            if (this.initContent) {
                this.initContent();
