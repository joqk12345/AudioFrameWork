...
(function (b) {
    ...
    b.extend(b.jqx._jqxGrid.prototype, {defineInstance: function () {
        ...
        if (this.host.jqxMenu) {
            ...
            this.gridmenu.jqxMenu({width: y, height: l, autoCloseOnClick: p, autoOpenPopup: false, mode: "popup", theme: this.theme, animationShowDuration: 0, animationHideDuration: 0, animationShowDelay: 0});
            if (this.filterable) {
        ...
        this._loading = true;
        this.dataview.update = function (p) {
            ...
            if ((f.source && f.source.sortcolumn) && f.sortby && !f.virtualmode) {
                ...
                var r = f.vScrollInstance.value;
                var o = f.hScrollInstance.value;
                var l = f.source ? f.source.datatype : "array";
                if (l != "local" || l != "array") {
                    var m = f.virtualsizeinfo == null || (f.virtualsizeinfo != null && f.virtualsizeinfo.virtualheight == 0);
                    if (i == "cells") {
                        var j = false;
                    ...
                    if (!f.virtualmode || m || (f.virtualmode && f.pageable)) {
                        ...
                        if (f.virtualmode && p == true && !f.pageable) {
                            f._render(true, true, false, false, false);
                            f._updatefocusedfilter();
                            f._updatecolumnwidths();
                            f._updatecellwidths();
                            ...
                            if (f.virtualmode && !f.pageable && p == false && i != undefined) {
                                f.rendergridcontent(true);
                                if (f.showaggregates && f._updateaggregates) {
                                    f._updateaggregates()
                                }
                    ...
                    if (f.vScrollInstance.value != r && r <= f.vScrollInstance.max) {
                        f.vScrollInstance.setPosition(r)
                    }
                    if (f.hScrollInstance.value != o && o <= f.hScrollInstance.max) {
                        f.hScrollInstance.setPosition(o)
                    }
                }
            }
            if (f.autoshowloadelement) {
        ...
        if (d != "sort" && d != "filter" && d != "cells" && d != "pagechanged" && d != "pagesizechanged" && !this.virtualmode) {
            ...
            if (!(this.hidden && this.hideable)) {
                if (this.width.toString().indexOf("%") != -1 || this._percentagewidth != undefined) {
                    ...
                    if (this._percentagewidth != undefined) {
                        p = parseFloat(this._percentagewidth) * (e - q) / 100
                    }
        ...
        b.each(this.columns.records, function (S, Q) {
            ...
            if (V.checkboxcolumn) {
                ...
                k.jqxCheckBox({_canFocus: false, disabledContainer: true, theme: u.theme, enableContainerClick: false, width: 16, height: 16, animationShowDelay: 0, animationHideDelay: 0});
                V.checkboxelement = k;
        ...
        p.addHandler(h, f, function (r) {
            ...
            if (m.menu && p.autoshowcolumnsmenubutton && !s) {
                o()
            }
        });
        ...
        if (g.host.jqxCheckBox) {
            ...
            if (j.find(".jqx-checkbox").length == 0) {
                ...
                b(e.firstChild).jqxCheckBox({_canFocus: false, hasInput: false, hasThreeStates: f.threestatecheckbox, enableContainerClick: false, animationShowDelay: 0, animationHideDelay: 0, locked: true, theme: g.theme, checked: h});
        ...
        if (h.host.jqxButton) {
            ...
            if (j.find(".jqx-button").length == 0) {
                ...
                b(e.firstChild).jqxButton({theme: h.theme, height: h.rowsheight - 4, width: g.width - 4});
        ...
        this._raiseEvent(19, {rowindex: s, datafield: y, newvalue: D, value: D, oldvalue: u});
        return true
        ...
        if (p != null && A >= 0) {
            this._raiseEvent(1, {rowindex: this.getboundindex(p), visibleindex: p.visibleindex, group: p.group, rightclick: m, originalEvent: P});
            ...
            this._raiseEvent(8, {rowindex: this.getboundindex(p), column: D ? D.getcolumnproperties() : null, datafield: D ? D.datafield : null, columnindex: A, value: F, rightclick: m, originalEvent: P});
            if (this.isTouchDevice()) {
            ...
            if (this._lastmousedown != null) {
                if (this._mousedown - this._lastmousedown < 300) {
                    if (this._clickedrowindex == this.getboundindex(p)) {
                        this._raiseEvent(22, {rowindex: this.getboundindex(p), visibleindex: p.visibleindex, group: p.group, rightclick: m, originalEvent: P});
                        if (this._clickedcolumn == D.datafield) {
                            this._raiseEvent(23, {rowindex: this.getboundindex(p), column: D ? D.getcolumnproperties() : null, datafield: D ? D.datafield : null, columnindex: A, value: F, rightclick: m, originalEvent: P})
                        }
                        f = true;
        ...
        switch (e) {
            ...
            case"touchmode":
                if (h != g) {
                    d._removeHandlers();
                    d.touchDevice = null;
                    d.vScrollBar.jqxScrollBar({touchMode: g});
                    d.hScrollBar.jqxScrollBar({touchMode: g});
            ...
            case"theme":
                if (g != h) {
                    ...
                    d.vScrollBar.jqxScrollBar({theme: d.theme});
                    d.hScrollBar.jqxScrollBar({theme: d.theme});
                    d.host.removeClass();
            ...
            case"disabled":
                ...
                if (d.pageable) {
                    if (d.pagerrightbutton) {
                        d.pagerrightbutton.jqxButton({disabled: g});
                        d.pagerleftbutton.jqxButton({disabled: g});
                        d.pagershowrowscombo.jqxDropDownList({disabled: g});
                        d.pagergotoinput.attr("disabled", g)
                    }
                }
                d.vScrollBar.jqxScrollBar({disabled: g});
                d.hScrollBar.jqxScrollBar({disabled: g});
                break
        }
    }});
    function c(d, e) {
