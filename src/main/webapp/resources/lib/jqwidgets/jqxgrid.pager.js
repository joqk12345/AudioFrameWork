...
(function (a) {
    a.extend(a.jqx._jqxGrid.prototype, {_initpager: function () {
        ...
        if (!this.pagerrenderer) {
            ...
            this.pagershowrowscombo.jqxDropDownList({rtl: this.rtl, disabled: this.disabled, source: o, enableBrowserBoundsDetection: true, keyboardSelection: false, autoDropDownHeight: true, width: 44, height: 16, theme: this.theme});
            var q = 0;
            ...
            this.addHandler(this.pagershowrowscombo, "select", function (w) {
                if (w.args) {
                    ...
                    if (v >= 100) {
                        r.pagershowrowscombo.jqxDropDownList({width: 55})
                    } else {
