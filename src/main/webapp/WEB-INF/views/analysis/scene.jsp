...
//                        alert("data" + dataRecord.path);
        ...
        form.attr('action', 'senceExport.do');
        var input1 = $('<input>');
...
//                                            alert(id);
                                    ...
                                    $("#popupWindow").jqxWindow({position: {x: parseInt(offset.left) + 60, y: parseInt(offset.top) + 60}, maxHeight: SencePOPHeight, maxWidth: SencePopWeight, width: InitSencePopWeight, height: InitSencePOPHeight});
...
//                                                        {text: '路径', datafield: 'path', width: 300},
                                                                    ...
                                                                    {text: '开始时间点', datafield: 'timeStart', width: 70, cellsalign: 'right'},
                                                                    {text: '结束时间点', datafield: 'timeEnd', width: 70, cellsalign: 'right', cellsformat: 'c2'},
...
//                            {text: '语速', datafield: 'speed', width: 90, cellsalign: 'right', cellsformat: 'c2'},
                    {text: '查看', datafield: 'Edit', columntype: 'button', cellsrenderer: function () {
                        ...
                        editrow = row;
                        var offset = $("#jqxgrid").offset();
                        $("#popupWindow").jqxWindow({position: {x: parseInt(offset.left) + 60, y: parseInt(offset.top) + 60}, maxWidth: SencePopWeight});
...
//                                                        {text: '路径', datafield: 'path', width: 300},
    ...
    $("#popupWindow").jqxWindow({
        width: SencePopWeight, height: SencePOPHeight, resizable: true, isModal: true, autoOpen: false, modalOpacity: 0.01, theme: Theme
    });
