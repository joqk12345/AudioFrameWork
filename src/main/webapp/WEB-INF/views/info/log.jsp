                            ...
                            $("#jqxgrid").jqxGrid(
                                    {
                                        ...
                                        pageable: true,
                                        columns: [
                                            {text: '用户名', width: 180, datafield: 'uname', cellsalign: 'left', align: 'right'},
                                            {text: '操作时间', datafield: 'time'},
                                            {text: '使用主机地址', datafield: 'hostIp'},
                                            {text: '操作项目', datafield: 'op'},
                                            {text: '操作内容', datafield: 'opcontent'}
                                        ]
                                    });
...
//            var data = generatedata(100);
            var data = [
                {"date": "admin1", "callnum": "2013-12-27 18:06:14", "peoplenum": "192.168.10.242", "peopleffective": "用户管理", "available": "登陆系统"},
                {"date": "root", "callnum": "2013-12-27 18:06:14", "peoplenum": "192.168.10.242", "peopleffective": "用户管理", "available": "登陆系统"},
                {"date": "admin", "callnum": "2013-12-27 18:06:14", "peoplenum": "192.168.10.241", "peopleffective": "用户管理", "available": "登陆系统"},
                {"date": "admin2", "callnum": "2013-12-27 18:06:14", "peoplenum": "192.168.10.243", "peopleffective": "用户管理", "available": "登陆系统"},
                {"date": "admin4", "callnum": "2013-12-27 18:06:14", "peoplenum": "192.168.11.242", "peopleffective": "用户管理", "available": "登陆系统"},
                {"date": "admin8", "callnum": "2013-12-27 18:06:14", "peoplenum": "192.168.10.242", "peopleffective": "用户管理", "available": "登陆系统"}
            ];
            ...
            $("#jqxgrid").jqxGrid(
                    {
                        ...
                        pageable: true,
                        columns: [
                            {text: '用户名', width: 180, datafield: 'date', cellsalign: 'left', align: 'right'},
                            {text: '操作时间', datafield: 'callnum'},
                            {text: '使用主机地址', datafield: 'peoplenum'},
                            {text: '操作项目', datafield: 'peopleffective'},
                            {text: '操作内容', datafield: 'available'}
                        ]
                    });
